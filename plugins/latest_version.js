      ...
      r.repo.listTags(function(err, tags) {
        if (err) {
          ...
          if (version_tag) {
            ...
            checkForgeCommits(name, repo, r, version, version_url, version_tag.tag, r.github.user, r.info.ref, html);
          } else {
...
function checkForgeCommits(name, repo, tags_r, version, url, base_version, ref_user, b, html) {
  var state;
  var customkey;
